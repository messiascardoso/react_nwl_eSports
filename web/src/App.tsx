    ...
    <div className='max-w-[1344px] mx-auto flex flex-col items-center my-20'>
      ...
      <div className='grid grid-cols-6 gap-6 mt-16'>
        <a href="" className='relative rounded-lg overflow-hidden'>
          ...
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0">
            <strong className='font-bold text-white block'>4 League of Legends</strong>
      ...
      <div className='pt-1 bg-nlw-gradient self-stretch rounded-lg mt-8 overflow-hidden'>
        <div className='bg-[#2A2634] px-8 py-6 self-stretch flex justify-between items-center'>
          ...
          <button className='text-white py-3 px-4 bg-violet-500 hover:bg-violet-600 rounded-md flex items-center gap-3'>
